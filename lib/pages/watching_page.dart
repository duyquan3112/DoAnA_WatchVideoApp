...
import 'package:do_an/widgets/comment_area.dart';
import 'package:do_an/widgets/owner_tag.dart';
import 'package:do_an/widgets/video_info.dart';
  ...
  void initState() {
    ...
    flickManager = FlickManager(
      ...
      videoPlayerController:
          VideoPlayerController.network(widget.info?.url ?? ''),
      autoInitialize: true,
      autoPlay: true,
    );
  }
